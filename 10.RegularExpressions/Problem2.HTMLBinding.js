...
console.log('<div data-bind-content="name"></div>'.bind('', {name: 'Pesho'}));
console.log('<a data-bind-content="name" data-bind-href="link" data-bind-class="name"></div>'.bind('', {name: 'Kiro', link: 'http://telerikacademy.com'}));
